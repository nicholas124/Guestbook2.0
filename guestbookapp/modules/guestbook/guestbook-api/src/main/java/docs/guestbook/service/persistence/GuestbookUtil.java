...
package docs.guestbook.service.persistence;
...
public class GuestbookUtil {
	...
	public static Guestbook findByUuid_First(
		...
		throws docs.guestbook.exception.NoSuchGuestbookException {
